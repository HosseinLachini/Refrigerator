...
void DisplayPanel::printErrorHE()
{
    printHex(0x0E);
    _print_buf[DISPLAYPANEL_TEN_DIGIT] = DISPLAYPANEL_SEG_B | DISPLAYPANEL_SEG_C | DISPLAYPANEL_SEG_E | DISPLAYPANEL_SEG_F | DISPLAYPANEL_SEG_G;
}
...
void DisplayPanel::printFa()
{
    printHex(0xFA);
}

void DisplayPanel::printHr()
{
    _print_buf[DISPLAYPANEL_TEN_DIGIT] = DISPLAYPANEL_SEG_B | DISPLAYPANEL_SEG_C | DISPLAYPANEL_SEG_E | DISPLAYPANEL_SEG_F | DISPLAYPANEL_SEG_G;
    _print_buf[DISPLAYPANEL_ONE_DIGIT] = DISPLAYPANEL_SEG_E | DISPLAYPANEL_SEG_G;
    _print_buf[DISPLAYPANEL_LEDS_DIGIT] &= ~DISPLAYPANEL_MINUS_DIGIT_IDX;
}
