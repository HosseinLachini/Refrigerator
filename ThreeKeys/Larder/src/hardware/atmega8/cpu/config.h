...
#define PARS_REFRIGERATOR_ARCHITECTURE_CPU         0x1000
#define PARS_REFRIGERATOR_ARCHITECTURE_CPU_STRING  "atmega8"

#define PARS_EEPROM_PACKED __attribute__((packed))
